...
#Also to calculate the changes in species richness and conservation status (LR, SPEC and EU) between both periods. This is for sensitivity
...
combindex_HP_CP <- st_read("Spatial_Data/combindexHP_CP_26June_sensitivity.shp")
...
write_sf(Indexes_HP_CP_complete, "Spatial_Data/HPCP_PASPA_27June_sensitivity.shp") #This shp has 4823 cells because those cells without richness data were removed.
...
FilteredHP <- read.csv("Data/FilteredHP_sensitivity.csv", stringsAsFactors = F)
...
write_xlsx(ACs_stats_30June, 'Data/ACs_stats_1july_sensitivity.xlsx') 
write_sf(hotspfinal_HP, "Spatial_Data/hotspfinal_HP_sensitivity.shp")
write_sf(hotspfinal_CP, "Spatial_Data/hotspfinal_CP_sensitivity.shp")
...
# Saving the image
dev.copy(pdf, "Figures/combined_plots_indexes_1July_scaled_sensitivity.pdf")
dev.off()
...
ggsave("Figures/indexes1_6_27Junesc_sensitivity.png", mapa_completo, wi = 34, he = 45, un = "cm", dpi = 300)
...
ggsave("Figures/indexes7_12_27Junesc_sensitivity.png", mapa_completo1, wi = 34, he = 45, un = "cm", dpi = 300)
...
ggsave("Figures/hotspotsHPCP_27Junesc_sensitivity.pdf", Hotspots_HP_CP, wi = 20, he = 25, un = "cm", dpi = 600)
...
ggsave("Figures/PASPAs2004_2Oct2024_sensitivity.png", PASPAs2004, wi = 20, he = 25, un = "cm", dpi = 600)
ggsave("Figures/PASPAs2022_2Oct2024_sensitivity.png", PASPAs2022, wi = 20, he = 25, un = "cm", dpi = 600)
